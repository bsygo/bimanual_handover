...
class SynGraspGen():
    ...
    def gen_joint_config(self, alphas, normalize = False):
        # Switch current joint values into order required for the hand synergies.
        ...
        # Generate next joint configuration based on alphas and write them into a dict.
        ...
        # Publish generated joint configuration as display state if required.
    ...
    def normalize(self, joint_dict, current_joint_config):
        '''
        Normalize changes in the joint dict to have a maximum change of 10 degree.
        '''
        joint_diffs = {}
    ...
    def limit_joints(self, joint_dict, current_joint_config):
        '''
        Set the fourth joints of parallel fingers to fixed values.
        '''
    ...
    def enforce_bounds(self, joint_dict):
        '''
        Set joint values to be inside joint limits.
        '''
        for joint in joint_dict:
    ...
    def exec_joint_config(self, joint_dict):
        '''
        Move hand to given joint configuration.
        '''
    ...
    def move_joint_config(self, alphas = np.array([0, 0, 0])):
        '''
        Call this function to generate and execute a joint configuration based on the given synergy weights (alphas).
        '''
    ...
    def publish_trajectory(self, joint_dict):
        '''
        Publish generated joint configuration as trajectory.
        '''
